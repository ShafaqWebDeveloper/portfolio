  ...
  return (
    (<div
      ...
      <div className=" p-4 max-w-7xl  mx-auto relative z-10  w-full pt-20 md:pt-0">
        ...
        <p className="mt-4 font-normal text-base text-neutral-300 max-w-lg text-center mx-auto">Hi, I’m  a Full Stack Developer Creating Scalable & Engaging Web Solutions.</p>
        <p
